This is a automatize Pure Premium calculator for Life Insurance Using Object Orienten programming and Actuarial Life Insurance
Models: Makeham's Law. It calculate:
...
The code display an informative text file for the user for a better understanding.
